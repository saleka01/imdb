...
<?php include "db.php"; ?>
<?php
$query = "SELECT MIN(filmek.ev) AS evjarat, filmek.film_nev AS LegregebbbiFilm\n"
...
<div class="container">
    ...
    <div class="col-sm-6">
        ...
        while ( ($current_row = mysqli_fetch_assoc($result))!= null) {    // most asszociatív tömbként kezeljük a sorokat
            echo '<tr>';
            echo '<td>' . $current_row["evjarat"] . '</td>';
            echo '<td>' . $current_row["LegregebbbiFilm"] . '</td>';
            echo '</tr>';
        }
        echo '</table>';
